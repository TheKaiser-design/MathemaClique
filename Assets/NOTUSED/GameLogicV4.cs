...
public class GameLogicV4 : MonoBehaviour
{
    public PuzzleGeneratorV2 generator;
    public List<string> values = new List<string>();
    public List<int> answers = new List<int>();
    public PuzzleGeneratorV2.DifficultyLevel currentDifficulty;
    ...
    public void NextPuzzle()
    {
        ...
        generator.GeneratePuzzle(currentDifficulty);
        GenerateNewPuzzle();
    }

    public void SetEasy()
    {
        currentDifficulty = PuzzleGeneratorV2.DifficultyLevel.Easy;
        generator.GeneratePuzzle(currentDifficulty);
        GenerateNewPuzzle();
    }
    ...
    public void SetHard()
    {
        currentDifficulty = PuzzleGeneratorV2.DifficultyLevel.Hard;
        generator.GeneratePuzzle(currentDifficulty);
        GenerateNewPuzzle();
    }
}
